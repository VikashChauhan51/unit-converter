        ...
        static readonly List<HomeMenuItem> menuItems = new List<HomeMenuItem>
            {
                ...
                new HomeMenuItem { Title="Illuminance Converter", Icon="lever.png",TargetType=typeof(IlluminanceConverterPage) },
                new HomeMenuItem { Title="Inductance Converter", Icon="lever.png",TargetType=typeof(InductanceConverterPage) },
                new HomeMenuItem { Title="Length Converter", Icon="length.png",TargetType=typeof(LengthConverterPage) },
                new HomeMenuItem { Title="Magnetic Field Converter", Icon="length.png",TargetType=typeof(MagneticFieldConverterPage) },
                new HomeMenuItem { Title="Magnetic Field Strength", Icon="length.png",TargetType=typeof(MagneticFieldStrengthConverterPage) },
                new HomeMenuItem { Title="Magnetic Flux Converter", Icon="length.png",TargetType=typeof(MagneticFluxConverterPage) },
                new HomeMenuItem { Title="Metric Converter", Icon="length.png",TargetType=typeof(MetricConverterPage) },
                new HomeMenuItem { Title="Molar Mass Converter", Icon="length.png",TargetType=typeof(MolarMassConverterPage) },
                new HomeMenuItem { Title="Pressure Converter", Icon="length.png",TargetType=typeof(PressureConverterPage) },
                new HomeMenuItem { Title="Radioactive Decay Converter", Icon="length.png",TargetType=typeof(RadioactiveDecayPage) },
                new HomeMenuItem { Title="Resistance Converter", Icon="flash.png",TargetType=typeof(ElectricalResistanceConverterPage) },
                new HomeMenuItem { Title="Speed Converter", Icon="length.png",TargetType=typeof(SpeedConverterPage) },
                ...
                new HomeMenuItem { Title="Torque Converter", Icon="temperature.png",TargetType=typeof(TorqueConverterPage) },
                new HomeMenuItem { Title="Volume Converter", Icon="temperature.png",TargetType=typeof(VolumeConverterPage) },
                new HomeMenuItem { Title="Weight Converter", Icon="temperature.png",TargetType=typeof(WeightConverterPage) },
